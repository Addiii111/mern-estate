  ...
  const handelSubmit = async (e) => {
    ...
    try {
      ...
      const config = {
       ...
       await axios
      .post(`api/updateUser/${currentUser.data._id}`, JSON.stringify(formData), config)
      .then((res) => {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handelSubmit} className='flex flex-col gap-4'>
        ...
        <Link className='bg-green-700 text-white p-3 rounded-lg uppercase text-center hover:opa95\' to={"/create-listing"}>   create listing</Link>
      </form>
...
userListings.map((listing) =>(
  ...
  <div key={listing} className="border rounded-lg p-3 flex justify-between
  gap-4 items-center">
